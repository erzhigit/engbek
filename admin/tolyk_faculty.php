	...
	<div class = "content">
		<div class = "content_wrapper" style = "width: 100%; margin: 0 auto; margin-top: 10px;">		
			<?php
				...
				$univ = array_sum($a);
				$sql2 = mysqli_query($connection,"SELECT engbekter.engbekID, SUM(engbekter.ball) AS sum_val, $univ/faculties.shtat_sany AS avg_faculty, engbekter.file_ati, engbekter.sani, engbekter.univ_avtor_san, engbekter.eskertu, engbekter.ball, faculties.facultyNameKZ, faculties.FacultyID, faculties.facultyDean, tutors.lastname, tutors.TutorID, tutors.firstname, tutors.firstnameRu, tutors.patronymic, tutors.firstnameRu,  faculties.facultyNameRU, tutors.lastnameRu, tutors.patronymicRu
				FROM faculties
